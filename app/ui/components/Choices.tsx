...
export default function Choices({characters, random}:{characters:Character[] | undefined, random: Character | undefined}){
    ...
    return(
        <div className="flex flex-col items-center overflow-y-auto w-max h-full">
            <div className="grid grid-cols-9 gap-2 text-[0.5em] lg:text-sm text-center font-bold text-[#584c44] h-20">
